...
// git clone -b test --single-branch https://github.com/Ignejoneigne/AWS_task_D4ML.git
...
// Use the AWS CLI to upload the entire /var/log/ directory to the newly created folder in S3 bucket
